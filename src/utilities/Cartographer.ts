...
export const ROOMTYPE_HIGHEAY = 'HIGHWAY';

/**
 * Cartographer: provides helper methods related to Game.map.
 */
@profile
export class Cartographer {
	 ...
	 */
	public static roomType(roomName: string): 'SK' | 'CORE' | 'CTRL' | 'HIGHWAY' {
		const coords = this.getRoomCoordinates(roomName);
		if (coords.x % 10 === 0 || coords.y % 10 === 0) {
			return ROOMTYPE_HIGHEAY;
