import { ROLE_FILLER, ROLE_MINER, ROLE_UPGRADER } from "Bee/BeeFactory";
...
import { PROCESS_BOOST, PROCESS_FILLING, PROCESS_MINE_SOURCE, PROCESS_UPGRADE } from "./Processes";
