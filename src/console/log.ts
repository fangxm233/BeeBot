...
export class Log {
	...
	public throw(e: Error) {
		console.log.apply(this, this.buildArguments(FATAL).concat([color(e.toString(), fatalColor)]) as any); // as any: 消除VSC报错
	}

	public error(...args: any[]): undefined {
		if (this.level >= LogLevels.ERROR) {
			console.log.apply(this, this.buildArguments(LogLevels.ERROR).concat([].slice.call(args)) as any); // as any: 消除VSC报错
		}
		return undefined;
	}
	...
	public warning(...args: any[]): undefined {
		if (this.level >= LogLevels.WARNING) {
			console.log.apply(this, this.buildArguments(LogLevels.WARNING).concat([].slice.call(args)) as any); // as any: 消除VSC报错
		}
		return undefined;
	}
	...
	public alert(...args: any[]): undefined {
		if (this.level >= LogLevels.ALERT) {
			console.log.apply(this, this.buildArguments(LogLevels.ALERT).concat([].slice.call(args)) as any); // as any: 消除VSC报错
		}
		return undefined;
	}
	...
	public info(...args: any[]): undefined {
		if (this.level >= LogLevels.INFO) {
			console.log.apply(this, this.buildArguments(LogLevels.INFO).concat([].slice.call(args)) as any); // as any: 消除VSC报错
		}
		return undefined;
	}
	...
	public debug(...args: any[]) {
		if (this.level >= LogLevels.DEBUG) {
			console.log.apply(this, this.buildArguments(LogLevels.DEBUG).concat([].slice.call(args)) as any); // as any: 消除VSC报错
		}
	}
	...
	public printObject(obj: any) {
		console.log.apply(this, this.buildArguments(LogLevels.DEBUG).concat(JSON.stringify(obj)) as any); // as any: 消除VSC报错
	}
